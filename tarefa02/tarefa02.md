...
## 4. Arquivos Desenvolvidos na Tarefa - Comparativo Prático (Driver vs ORM):
* [Script de Povoamento Inicial](preparar_dados.py)
* [Script de execução via Driver/SQL](teste_driver.py)
* [Script de execução via Django ORM](teste_orm.py)
...
### 4.1 Execução via Driver SQL (`teste_driver.py`).
...
### 4.2 Execução via Django ORM (`teste_orm.py`)
